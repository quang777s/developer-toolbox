    ...
    <main className="pt-16 p-4 container mx-auto">
      <header className="text-center mb-8">
        ...
        <p className="text-gray-600 mt-2 max-w-2xl mx-auto">
          A small collection of developer utilities: quick-copy, QR code
          generator, and a flexible template renderer. Use the Tools page to
          create and copy content quickly.
        </p>
        <div className="mt-6">
          <Link
            to="/tools"
      ...
      <section className="grid md:grid-cols-3 gap-6">
        ...
        <article className="p-4 border rounded">
          <h3 className="font-semibold">Template Renderer</h3>
          <p className="text-sm text-gray-600 mt-2">
